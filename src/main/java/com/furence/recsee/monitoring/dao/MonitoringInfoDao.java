package com.furence.recsee.monitoring.dao;
...
public interface MonitoringInfoDao {
	...
	Integer countItemList(ControlTargetVO controlTargetVO);
	List<ItemVo> targetItemCombo(ControlTargetVO controlTargetVO);
	Integer deleteItemList(ControlTargetVO controlTargetVO);
