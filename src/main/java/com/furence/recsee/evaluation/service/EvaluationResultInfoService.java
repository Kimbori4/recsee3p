package com.furence.recsee.evaluation.service;
...
public interface EvaluationResultInfoService {
	// 평가된 리스트 조회
	...
	//평가 캠페인 만들기에서 수정 버튼 클릭 시 추가되는 시트
	...
	List<Map<String, Object>> selectsGroup(Map<String, Object> evaluationResultInfo);
	List<Map<String, Object>> selectmGroup(Map<String, Object> evaluationResultInfo);
	List<Map<String, Object>> selectallGroup(Map<String, Object> evaluationResultInfo);
	List<Map<String, Object>> selectallPerson(Map<String, Object> evaluationResultInfo);
