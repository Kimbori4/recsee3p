...
<script type="text/javascript" src="${recseeResourcePath}/js/page/wooribank/script/script_approve_result.js?ver=20220331"></script>
		...
		<div id="search_box" class="search_box enable">
			<div id="script_info_box" class="script_menu_class float_left">
				<section id="filter" class="filter" >
					<div style="height: 25px; font-weight: bold; margin: 10px 0 10px 6px; color : white">결재이력</div>
					<div id="fixed_div">
						<ul style="display:flex; align-items: center">
							...
							<div id='filterScriptApproveDate'class='filterScriptVal'style="font-size:13px;margin:0px 3px 2px 5px;font-weight:700;color:white;">ㆍ 결재일</div>
							...
							<div id="searchBox" style="position:relative">
								<input autocomplete="off" type="text" id="resultSearchKeyword" class="search_script_contents" placeholder="검색어를 입력하세요." style="ime-mode:active" />
				...
				<div id="scriptApproveReportListGrid" class="script_approve_report_list_grid"></div>
			...
			<div id="scriptApproveBeforeAfter" class="script_approve_Before_After " style="display: none; width : 100%; height : auto;">
				...
				<button id="scriptApprovalList" class="script_approval_list">결재이력 보기</button>
				<button id="scriptReturningCancel" class="script_returning_cancel">결재의뢰 취소</button>
