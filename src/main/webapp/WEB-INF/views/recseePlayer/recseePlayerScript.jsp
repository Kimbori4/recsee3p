...
<head>
	...
	<script type="text/javascript" src="<c:out value="${compoResourcePath}"/>/recsee_player_script/recsee_player.js?ver=1238"></script>
    ...
    $(function() {
    	...
    	rc_player = new RecseePlayer({
			...
			,	"wave"   			: false				// 웨이브 표출여부 (비 활성시 구간 지정 기능 사용 불가)
