...
<head>
	...
	<%-- js page --%>
	<script type="text/javascript" src="${recseeResourcePath }/js/page/transcript/sttEnginState.js"></script>
	<script>
	$(function() {
	    $(window).resize(function() {
			...
			// 그리드 위의 높이 값
			var gridCalcHeight = $("#gridSttEnginState").offset().top;
			...
			$("#gridSttEnginState").css({"height": + gridResultHeight + "px"});
	    }).resize();
	})
	</script>
</head>
    ...
    <div class="ui_layout_pannel">
        ...
        <div class="ui_layout_pannel">
        	<div class="main_pannel">
				<div class="gridWrap">
					<div id="gridSttEnginState" style="width:100%"></div>
					<div id="pagingSttEnginState"></div>
				</div>
			</div>
		</div>
    	</div>
