...
<head>
	...
	<%-- js page --%>
	<script type="text/javascript" src="${recseeResourcePath }/js/page/admin/screen_manage.js"></script>
	...
	<script>
		$(function() {
		    $(window).resize(function() {
				...
				// 그리드 위의 높이 값
				var gridCalcHeight = $("#gridScreenManage").offset().top;
				...
				$("#gridScreenManage").css({"height": + (gridResultHeight - 4) + "px"})	
		    }).resize();
		})
	</script>
	        ...
	        <div class="ui_acrticle">
	            <div class="ui_pannel_row">
	                <div class="ui_float_left">
		                <button class="ui_main_btn_flat icon_btn_adduser_white">Additional User</button>
		                <button class="icon_btn_trashTxt_gray">User Cancellation</button>
	                </div>
	            </div>
		        <div class="gridWrap">
			        <div id="gridScreenManage"></div>
			        <div id="pagingScreenManage"></div>
		        </div>
        	</div>
