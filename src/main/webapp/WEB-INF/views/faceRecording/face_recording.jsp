    ...
    <div class="main_contents">
		<div id="top_box">
			<div id="cust_info_box" class="top_box_contents">
				<div id="cust_info_contents">
					<ul>
						<li><label>고객명</label><input type="text" id="custName" value="김다빈"></li>
                        <li><label>고객번호</label><input type="text" id="custNum" value="1001"></li>
                        <li><label>전화번호</label><input type="text" id="custPhone" value="01012345678"></li>
                        <li><label>가입 상품</label><select id="custProduct"><option value='' id=''>가입 상품 선택</option><option value='direct' id='direct'>추가</option></select></li>
					</ul>
					<div id="cust_info_save_btn">저장</div>
				</div>
			</div>
			<div id="recording_box" class="top_box_contents">
			<div id="recording_player">
				<div class="rec_script_title"></div>
				<div id="rec_wave"></div>
				<div class="rec_player_controller">
					<div class="info_controller">
						<div class="play_time"><span id="now_time">00:00:00</span>/<span id="total_time">00:00:00</span></div>
					</div>
					<div class="play_controller">
						<div id="pre_btn" class="pre_btn_unload"></div>
						<div id="play_btn" class="play"></div>
						<div id="next_btn" class="next_btn_unload"></div>
					</div>
				</div>
			</div>
			</div>
			<div id="user_info_box" class="top_box_contents">
				<div id="user_info_contents">
					<ul>
						<li><label>상담원ID</label><input type="text" id="userId" value="<c:out value="${userId}"/>"></li>
                        <li><label>상담원명</label><input type="text" id="userName" value="<c:out value="${userName}"/>"></li>
                        <li><label>내선번호</label><input type="text" id="extNum" value="<c:out value="${extNo}"/>"></li>
                        <li><label>판매 상품</label><input type="text" id="sellProduct" disabled="disabled"></li>
					</ul>
				</div>
			</div>
		</div>
		<div id="bottom_box">
			...
			<div id="select_script_box" class="script_menu_class float_left">
				<div style="width:5px; height:25px; background-color:#449ed7; margin:6px 5px 0 0;" class="float_left"></div>
				<div style="height:25px; font-weight: bold; margin:10px 0 10px 0;">스크립트 선택</div>
				
				<input type="text" id="select_script" placeholder="검색어를 입력해주세요."/>
				<button id="search_script_btn">검색</button>
				<select id="script_list" name="script_list[]" multiple="multiple">
					<option value='' disabled="disabled">파일</option>
				</select>
				<button id="select_script_btn">선택</button>
			</div>
			...
			<div id="script_info_box" class="script_menu_class float_left">
				...
				<ul style="height:52%">
					<li><label>스크립트명</label><input type="text" id="scriptName" class="add_script_contents"/></li>
					<li><label>스크립트 분류</label>
					...
					<li><label>첨부 파일</label>
               			<input class="upload_name" id="upload_name1" value="파일을 선택하세요." readonly="readonly" style="width:70%">
						<label class="ButtonLabel" for="upLoadFile_hidden1" style="background-color: rgb(96, 179, 220); border-color: rgb(96, 179, 220); color: rgb(255, 255, 255); cursor: pointer; transition: all 0.3s ease 0s; clear:none; width:calc(10% + 5px);">파일찾기</label>
                       	<input type="file" name="upLoadFile_hidden1" id="upLoadFile_hidden1" class="upload_hidden" accept=".txt" style="display:none;">
					</li>
