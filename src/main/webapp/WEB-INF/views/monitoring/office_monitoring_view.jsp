...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${recseeResourcePath }/css/page/monitoring/realtime_office.css" />
	...
	<script type="text/javascript" src="${recseeResourcePath }/js/page/monitoring/realtime_officemonitoring.js"></script>
	<script type="text/javascript" src="${recseeResourcePath }/js/page/monitoring/drag_drop.js"></script>
	...
	<script>
		...
		$(function() {
			...
			$(window).resize(function() {
				...
				/* $(".office_view_pannel_bg").css({"height": bodyHeight+"px"}) */
				...
				$(".office_view_pannel").css({"min-height": + (documentHeight - bodyHeight - calcHeight - 2) + "px"});
			}).resize();
		});
		 ...
		 * */
		function selectOrganizationLoad(objSelect, comboType, bgCode, mgCode, selectedValue, defaultSelect){
			...
			<div class="ui_article option_pannel">
                <div class="ui_pannel_row">
                    ...
                    <div class="ui_float_right">
                    	<button id="officeMonitoringWindow" class="ui_sub_btn_flat icon_btn_view_white"><spring:message code="monitoring.display.showNew"/></button>
