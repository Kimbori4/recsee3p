...
<head>
	...
	<script type="text/javascript" src="${recseeResourcePath }/js/page/monitoring/realtime_gridView.js"></script>
	<script type="text/javascript" src="${recseeResourcePath }/js/page/monitoring/realtime_grid.js"></script>
    ...
    <div class="main_contents">
        ...
        <div class="ui_layout_pannel">
	        ...
	        <div class="monitoring_option" id="monitoring">
	            ...
	            <div class="display_option">
					...
					<div class="setting_dropdown_cont">
		                ...
		                <div class="option_check">
		                    <span class="onofftit"><spring:message code="monitoring.display.number"/></span>
		                    <div class='onoffswitch'>
		                        <input type='checkbox' name='selDisplay' class='onoffswitch-checkbox' id='selDisplayCallNum' checked/>
		                        <label class='onoffswitch-label' for='selDisplayCallNum'></label>
		                    </div>
		                </div>
		               <%--  <div class="option_check">
		                    <span class="onofftit"><spring:message code="monitoring.display.callTime"/></span>
		                    <div class='onoffswitch'>
		                        <input type='checkbox' name='selDisplay' class='onoffswitch-checkbox' id='selDisplayCallingTime' checked/>
		                        <label class='onoffswitch-label' for='selDisplayCallingTime'></label>
		                    </div>
		                </div> --%>
	                </div>
	            </div>
			...
			<div class="monitoring_contents">
                ...
                <div class="mode_cont" id="viewGridMode">
                    <div class="gridWrap">
